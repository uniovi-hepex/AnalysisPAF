...
plotsoutputpath2  = "./results/"
if not os.path.exists(plotsoutputpath2 + 'RespMat'):
    os.makedirs(plotsoutputpath2 + 'RespMat')

plotsoutputpath  = "./results/RespMat/"
if not os.path.isfile(plotsoutputpath2 + "/index.php"):
    shutil.copy2("/nfs/fanae/user/ireneaj/www/index.php", plotsoutputpath + "index.php")
...
def GetResponseMatrix(t1, t2, t3, vname, nxb, xb, nyb, yb, sys = "", nomtree = None):
  '''This function obtains the response matrix combining information of three trees.'''
  ...
  if "minmax" in vl.varList[vname]['var']: vname1 = vl.varList[vname]['name']
  else : vname1 = vname
  ...
  if not isinstance(t1, list):
    ...
    t1.Draw(vnamegen + '>>hGen1', genCut + "*(abs(TGen{vr}) < 1000)".format(vr = vname1))
    t2.Draw(vnamegen + '>>hGen2', genCut + "*(abs(TGen{vr}) < 1000)".format(vr = vname1))
    t3.Draw(vnamegen + '>>hGen3', genCut + "*(abs(TGen{vr}) < 1000)".format(vr = vname1)) #anadir la muestra ttbar
    hGen1.Add(hGen2)
    hGen1.Add(hGen3)
    del hGen2, hGen3
    ...
    t1[0].Draw(vnamegen + '>>hGen1', genCut + '*' + str(specialweight) + "*(abs(TGen{vr}) < 1000)".format(vr = vname1))
    t2[0].Draw(vnamegen + '>>hGen2', genCut + '*' + str(specialweight) + "*(abs(TGen{vr}) < 1000)".format(vr = vname1))
    specialweight = vl.n_twnohad/vl.sigma_twnohad/(vl.n_tw/vl.sigma_tw + vl.n_twnohad/vl.sigma_twnohad)
    t1[1].Draw(vnamegen + '>>hGen1noF', genCut + '*' + str(specialweight) + "*(abs(TGen{vr}) < 1000)".format(vr = vname1))
    t2[1].Draw(vnamegen + '>>hGen2noF', genCut + '*' + str(specialweight) + "*(abs(TGen{vr}) < 1000)".format(vr = vname1))
    specialweight = 1
    t3.Draw(vnamegen + '>>hGen3', genCut + '*' + str(specialweight) + "*(abs(TGen{vr}) < 1000)".format(vr = vname1))
    hGen1.Add(hGen2)
  ...
  if not isinstance(t1, list):
    ...
    specialweight = vl.n_tw/vl.sigma_tw/(vl.n_tw/vl.sigma_tw + vl.n_twnohad/vl.sigma_twnohad)
    t1[0].Project('h1', vnamereco + ":" + vnamegen, tmpcut + '*' + str(specialweight) + "*(abs(TGen{vr}) < 1000)*(abs(T{vr}) < 1000)".format(vr = vname1))
    t2[0].Project('h2', vnamereco + ":" + vnamegen, tmpcut + '*' + str(specialweight) + "*(abs(TGen{vr}) < 1000)*(abs(T{vr}) < 1000)".format(vr = vname1))
    specialweight = vl.n_twnohad/vl.sigma_twnohad/(vl.n_tw/vl.sigma_tw + vl.n_twnohad/vl.sigma_twnohad)
    t1[1].Project('h1noF', vnamereco + ":" + vnamegen, tmpcut + '*' + str(specialweight) + "*(abs(TGen{vr}) < 1000)*(abs(T{vr}) < 1000)".format(vr = vname1))
    t2[1].Project('h2noF', vnamereco + ":" + vnamegen, tmpcut + '*' + str(specialweight) + "*(abs(TGen{vr}) < 1000)*(abs(T{vr}) < 1000)".format(vr = vname1))
    t3.Project('h3', vnamereco + ":" + vnamegen, tmpcut + "*(abs(TGen{vr}) < 1000)*(abs(T{vr}) < 1000)".format(vr = vname1))
    h1.Add(h2)
    h1noF.Add(h2noF)
    h1.Add(h1noF)
    h1.Add(h3)
  ...
  if (sys == ""):
    if not isinstance(t1, list):
      ...
      t1.Draw(vnamereco + '>>hReco1', recoCut + "*(abs(T{vr}) < 1000)".format(vr = vname1))
      t2.Draw(vnamereco + '>>hReco2', recoCut + "*(abs(T{vr}) < 1000)".format(vr = vname1))
      t3.Draw(vnamereco + '>>hReco3', recoCut + "*(abs(T{vr}) < 1000)".format(vr = vname1))
      hReco1.Add(hReco2)
      hReco1.Add(hReco3)
      del hReco2, hReco3
    else:
      ...
      specialweight = vl.n_tw/vl.sigma_tw/(vl.n_tw/vl.sigma_tw + vl.n_twnohad/vl.sigma_twnohad)
      t1[0].Draw(vnamereco + '>>hReco1', recoCut + '*' + str(specialweight) + "*(abs(T{vr}) < 1000)".format(vr = vname1))
      t2[0].Draw(vnamereco + '>>hReco2', recoCut + '*' + str(specialweight) + "*(abs(T{vr}) < 1000)".format(vr = vname1))
      specialweight = vl.n_twnohad/vl.sigma_twnohad/(vl.n_tw/vl.sigma_tw + vl.n_twnohad/vl.sigma_twnohad)
      t1[1].Draw(vnamereco + '>>hReco1noF', recoCut + '*' + str(specialweight) + "*(abs(T{vr}) < 1000)".format(vr = vname1))
      t2[1].Draw(vnamereco + '>>hReco2noF', recoCut + '*' + str(specialweight) + "*(abs(T{vr}) < 1000)".format(vr = vname1))
      t3.Draw(vnamereco + '>>hReco3', recoCut   + "*(abs(T{vr}) < 1000)".format(vr = vname1))
      ...
      hReco1.Add(hReco3)
      del hReco2, hReco1noF, hReco2noF, hReco3
  ...
  if not isinstance(t1, list):
    if ('fsr' in t1.GetName() or 'FSR' in t1.GetName() or 'isr' in t1.GetName() or 'ISR' in t1.GetName()):
      ...
      nomtree[0].Project('h1nom', vnamereco + ":" + vnamegen, tmpcut + "*(abs(TGen{vr}) < 1000)*(abs(T{vr}) < 1000)".format(vr = vname1))
      nomtree[1].Project('h2nom', vnamereco + ":" + vnamegen, tmpcut + "*(abs(TGen{vr}) < 1000)*(abs(T{vr}) < 1000)".format(vr = vname1))
      h1nom.Add(h2nom)
      del h2nom
      hGen1nom = r.TH1F('hGen1nom', '', nxb, xb)
      hGen2nom = r.TH1F('hGen2nom', '', nxb, xb)

      nomtree[0].Draw(vnamegen + '>>hGen1nom', genCut + "*(abs(TGen{vr}) < 1000)".format(vr = vname1))
      nomtree[1].Draw(vnamegen + '>>hGen2nom', genCut + "*(abs(TGen{vr}) < 1000)".format(vr = vname1))
...
def GetFiducialHisto(t1, t2, t3, vname, nyb, yb, sys = "", nomtree = None):
  ...
  if not isinstance(t1, list):
    ...
    t1.Draw(vnamereco + '>>h1', tmpcut + "*(abs(T{vr}) < 1000)".format(vr = vname1))
    t2.Draw(vnamereco + '>>h2', tmpcut + "*(abs(T{vr}) < 1000)".format(vr = vname1))
    t3.Draw(vnamereco + '>>h3', tmpcut + "*(abs(T{vr}) < 1000)".format(vr = vname1))
    ...
    specialweight = vl.n_tw/vl.sigma_tw/(vl.n_tw/vl.sigma_tw + vl.n_twnohad/vl.sigma_twnohad)
    t1[0].Draw(vnamereco + '>>h1', tmpcut + '*' + str(specialweight) + "*(abs(T{vr}) < 1000)".format(vr = vname1))
    t2[0].Draw(vnamereco + '>>h2', tmpcut + '*' + str(specialweight) + "*(abs(T{vr}) < 1000)".format(vr = vname1))
    specialweight = vl.n_twnohad/vl.sigma_twnohad/(vl.n_tw/vl.sigma_tw + vl.n_twnohad/vl.sigma_twnohad)
    t1[1].Draw(vnamereco + '>>h1noF', tmpcut + '*' + str(specialweight) + "*(abs(T{vr}) < 1000)".format(vr = vname1))
    t2[1].Draw(vnamereco + '>>h2noF', tmpcut + '*' + str(specialweight) + "*(abs(T{vr}) < 1000)".format(vr = vname1))
    specialweight = 1
    t3.Draw(vnamereco + '>>h3', tmpcut + '*' + str(specialweight) + "*(abs(T{vr}) < 1000)".format(vr = vname1))
  ...
  if not isinstance(t1, list):
    if ('fsr' in t1.GetName() or 'FSR' in t1.GetName() or 'isr' in t1.GetName() or 'ISR' in t1.GetName()):
      ...
      nomtree[0].Draw(vnamereco + '>>h1nom', tmpcut + "*(abs(T{vr}) < 1000)".format(vr = vname1))
      nomtree[1].Draw(vnamereco + '>>h2nom', tmpcut + "*(abs(T{vr}) < 1000)".format(vr = vname1))
      h1nom.Add(h2nom)
      del h2nom
...
#queda anadir los de TTbar
fTTbar2L          = r.TFile.Open(minipath + "Tree_UNF_TTbar2L_powheg_0.root")
...
#queda anadir las de ttbar
treeTTbar2L      = fTTbar2L.Get('Mini1j1t')
