...
R__LOAD_LIBRARY(./TW/Differential/temp/LeadingLepEta.C+)
#include "Histo.h"
#include "Looper.h"
#include "Plot.h"
#include "Datacard.h"
#include "./TW/Differential/temp/LeadingLepEta.C"
...
void runCardsLeadingLepEta() {
  
  DrawPlot("theBDt_bin1( TBDT )", "(Tpassreco == 1 && TLeadingLepEta >= -2.4 && TLeadingLepEta < -1.75)",  "ElMu", 10, 0.5, 10.5, "LeadingLepEta_1","");
  DrawPlot("theBDt_bin2( TBDT )", "(Tpassreco == 1 && TLeadingLepEta >= -1.75 && TLeadingLepEta < -1.25)", "ElMu", 10, 0.5, 10.5, "LeadingLepEta_2","");
  DrawPlot("theBDt_bin3( TBDT )", "(Tpassreco == 1 && TLeadingLepEta >= -1.25 && TLeadingLepEta < -0.5)",  "ElMu", 10, 0.5, 10.5, "LeadingLepEta_3","");
  DrawPlot("theBDt_bin4( TBDT )", "(Tpassreco == 1 && TLeadingLepEta >= -0.5 && TLeadingLepEta < 0)",      "ElMu", 10, 0.5, 10.5, "LeadingLepEta_4","");
  DrawPlot("theBDt_bin5( TBDT )", "(Tpassreco == 1 && TLeadingLepEta >= 0 && TLeadingLepEta < 0.5)",       "ElMu", 10, 0.5, 10.5, "LeadingLepEta_5","");
  DrawPlot("theBDt_bin6( TBDT )", "(Tpassreco == 1 && TLeadingLepEta >= 0.5 && TLeadingLepEta < 1.25)",    "ElMu", 10, 0.5, 10.5, "LeadingLepEta_6","");
  DrawPlot("theBDt_bin7( TBDT )", "(Tpassreco == 1 && TLeadingLepEta >= 1.25 && TLeadingLepEta < 1.75)",   "ElMu", 10, 0.5, 10.5, "LeadingLepEta_7","");
  DrawPlot("theBDt_bin8( TBDT )", "(Tpassreco == 1 && TLeadingLepEta >= 1.75 && TLeadingLepEta < 2.4)",    "ElMu", 10, 0.5, 10.5, "LeadingLepEta_8","");
  return;
}
