...
//   DrawPlot("THTLepOverHT"           , StandardCut, "ElMu", 20,  0.,   1., "H_{T}+lep / H_{T}"                     , false, "units,0.05", 1e4);
  ...
  Float_t RB_TLeadingJetEta[]   = {-2.4, -1.6, -1.25, -.5, 0., .5, 1.25, 1.6, 2.4};
  ...
  DrawCustomPlot("TLeadingJetEta"         , StandardCut, "ElMu", sizeof(RB_TLeadingJetEta)/sizeof(*RB_TLeadingJetEta) - 1, RB_TLeadingJetEta   , "#eta^{j} [GeV]"            , false, "gev");
  ...
  DrawCustomPlot("TLeadingLepEta"         , StandardCut, "ElMu", sizeof(RB_TLeadingLepEta)/sizeof(*RB_TLeadingLepEta) - 1, RB_TLeadingLepEta   , "#eta^{l_{1}} [GeV]"        , false, "gev");
  ...
  DrawCustomPlot("TSubLeadingLepEta"      , StandardCut, "ElMu", sizeof(RB_TSubLeadingLepEta)/sizeof(*RB_TSubLeadingLepEta) - 1, RB_TSubLeadingLepEta, "#eta^{l_{2}} [GeV]"        , false, "gev");
}
