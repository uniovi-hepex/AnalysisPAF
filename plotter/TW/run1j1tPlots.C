...
//   DrawPlot("TLeadingLepPhi"         , StandardCut, "ElMu", 20,-TMath::Pi(),TMath::Pi(), "#varphi^{l_{1}} [GeV]", false, "gev");
  DrawPlot("abs(TLeadingLepEta)", StandardCut, "ElMu", 20,0, 2.4, "#eta^{l_{1}} [GeV]"                , false, "gev");
...
//   DrawPlot("TSubLeadingLepPhi"      , StandardCut, "ElMu", 20,-TMath::Pi(),TMath::Pi(), "#varphi^{l_{2}} [GeV]", false, "gev");
  DrawPlot("abs(TSubLeadingLepEta)", StandardCut, "ElMu", 20,  0, 2.4, "#eta^{l_{2}} [GeV]"             , false, "gev");
  
  Float_t RB_TMET[]             = {0., 20., 35., 50., 70., 140., 1000.};
  Float_t RB_TMET_Phi[]         = {-(Float_t) -TMath::Pi(), -2.25, -1.5, -.75, 0, .75, 1.5, 2.25, (Float_t) -TMath::Pi()};
  Float_t RB_TM_LeadingB[]      = {0., 45., 75., 105., 140., 190., 230., 300., 1000.};
  Float_t RB_TM_SubLeadingB[]   = {0., 50., 60., 80., 100., 125., 150., 200., 1000.};
  Float_t RB_TM_LLB[]           = {0., 125., 170., 180., 200., 240., 290., 350., 1000.};
  Float_t RB_TMT_LLMETB[]       = {0., 200., 270., 320., 380., 450., 1000.};
  Float_t RB_TE_LLB[]           = {0., 160., 220., 280., 340., 400., 450., 550., 1000.};
  Float_t RB_TDilepPt[]         = {0., 40., 60., 80., 90., 110., 130., 150., 500.};
  Float_t RB_TDilepJetPt[]      = {0., 20., 30., 50., 60., 90., 100., 140., 500.};
  Float_t RB_TDilepMETJetPt[]   = {0., 20., 30., 40., 50., 60., 70., 80., 500.};
  Float_t RB_THTtot[]           = {0., 150., 200., 250., 300., 350., 400., 450., 1000.};
  Float_t RB_TLeadingJetPt[]    = {0., 50., 75., 110., 150., 200., 500.};
  Float_t RB_TLeadingJetE[]     = {0., 40., 70., 120., 175., 275., 1000.};
  ...
  Float_t RB_TLeadingLepPt[]    = {0., 50., 65., 75., 90., 110., 130., 160., 1000.};
  Float_t RB_TLeadingLepE[]     = {0., 40., 60., 80., 100., 120., 150., 250., 1000.};
  ...
  Float_t RB_TSubLeadingLepPt[] = {0., 30., 40., 50., 58., 68., 78., 100., 1000.};
  Float_t RB_TSubLeadingLepE[]  = {0., 30., 50., 70., 90., 115., 140., 175., 1000.};
...
//   DrawCustomPlot("TMET_Phi"               , StandardCut, "ElMu", sizeof(RB_TMET_Phi)/sizeof(*RB_TMET_Phi) - 1,  RB_TMET_Phi         , "#varphi(#slash{E}_T) [GeV]"               , false, "gev");
//   DrawCustomPlot("TM_LeadingB"            , StandardCut, "ElMu", sizeof(RB_TM_LeadingB)/sizeof(*RB_TM_LeadingB) - 1,  RB_TM_LeadingB      , "m^{l_{1}b} [GeV]"                   , false, "gev");
//   DrawCustomPlot("TM_SubLeadingB"         , StandardCut, "ElMu", sizeof(RB_TM_SubLeadingB)/sizeof(*RB_TM_SubLeadingB) - 1, RB_TM_SubLeadingB   , "m^{l_{2}b} [GeV]"              , false, "gev");
//   DrawCustomPlot("TM_LLB"                 , StandardCut, "ElMu", sizeof(RB_TM_LLB)/sizeof(*RB_TM_LLB) - 1, RB_TM_LLB           , "m^{llb} [GeV]"                                 , false, "gev");
//   DrawCustomPlot("TMT_LLMETB"             , StandardCut, "ElMu", sizeof(RB_TMT_LLMETB)/sizeof(*RB_TMT_LLMETB) - 1, RB_TMT_LLMETB       , "m_T^{ll #nu #nu b} [GeV]"              , false, "gev");
//   DrawCustomPlot("TE_LLB"                 , StandardCut, "ElMu", sizeof(RB_TE_LLB)/sizeof(*RB_TE_LLB) - 1, RB_TE_LLB           , "E^{llb} [GeV]"                                 , false, "gev");
//   DrawCustomPlot("TDilepPt"               , StandardCut, "ElMu", sizeof(RB_TDilepPt)/sizeof(*RB_TDilepPt) - 1, RB_TDilepPt         , "p_T^{ll} [GeV]"                            , false, "gev");
//   DrawCustomPlot("TDilepJetPt"            , StandardCut, "ElMu", sizeof(RB_TDilepJetPt)/sizeof(*RB_TDilepJetPt) - 1, RB_TDilepJetPt      , "p_{T}^{e#mu, j} [GeV]"               , false, "gev");
//   DrawCustomPlot("TDilepMETJetPt"         , StandardCut, "ElMu", sizeof(RB_TDilepMETJetPt)/sizeof(*RB_TDilepMETJetPt) - 1, RB_TDilepMETJetPt   , "p_{T}^{e#mu, j, MET} [GeV]"    , false, "gev");
//   DrawCustomPlot("THTtot"                 , StandardCut, "ElMu", sizeof(RB_THTtot)/sizeof(*RB_THTtot) - 1, RB_THTtot           , "H_{T} [GeV]"                                   , false, "gev");
...
//   DrawCustomPlot("TLeadingJetPhi"         , StandardCut, "ElMu", sizeof(RB_TLeadingJetPhi)/sizeof(*RB_TLeadingJetPhi) - 1, RB_TLeadingJetPhi   , "#varphi^{j} [GeV]"             , false, "gev");
...
//   DrawCustomPlot("TLeadingLepPt"          , StandardCut, "ElMu", sizeof(RB_TLeadingLepPt)/sizeof(*RB_TLeadingLepPt) - 1, RB_TLeadingLepPt    , "p_{T}^{l_{1}} [GeV]"             , false, "gev");
//   DrawCustomPlot("TLeadingLepE"           , StandardCut, "ElMu", sizeof(RB_TLeadingLepE)/sizeof(*RB_TLeadingLepE) - 1, RB_TLeadingLepE     , "E^{l_{1}} [GeV]"                   , false, "gev");
//   DrawCustomPlot("TLeadingLepPhi"         , StandardCut, "ElMu", sizeof(RB_TLeadingLepPhi)/sizeof(*RB_TLeadingLepPhi) - 1, RB_TLeadingLepPhi   , "#varphi^{l_{1}} [GeV]"         , false, "gev");
  DrawCustomPlot("abs(TLeadingLepEta)", StandardCut, "ElMu", sizeof(RB_TLeadingLepEta)/sizeof(*RB_TLeadingLepEta) - 1, RB_TLeadingLepEta   , "#eta^{l_{1}} [GeV]"         , false, "gev");
//   DrawCustomPlot("TSubLeadingLepPt"       , StandardCut, "ElMu", sizeof(RB_TSubLeadingLepPt)/sizeof(*RB_TSubLeadingLepPt) - 1, RB_TSubLeadingLepPt , "p_{T}^{l_{2}} [GeV]"       , false, "gev");
//   DrawCustomPlot("TSubLeadingLepE"        , StandardCut, "ElMu", sizeof(RB_TSubLeadingLepE)/sizeof(*RB_TSubLeadingLepE) - 1, RB_TSubLeadingLepE  , "E^{l_{2}} [GeV]"             , false, "gev");
//   DrawCustomPlot("TSubLeadingLepPhi"      , StandardCut, "ElMu", sizeof(RB_TSubLeadingLepPhi)/sizeof(*RB_TSubLeadingLepPhi) - 1, RB_TSubLeadingLepPhi, "#varphi^{l_{2}} [GeV]"   , false, "gev");
  DrawCustomPlot("abs(TSubLeadingLepEta)", StandardCut, "ElMu", sizeof(RB_TSubLeadingLepEta)/sizeof(*RB_TSubLeadingLepEta) - 1, RB_TSubLeadingLepEta, "#eta^{l_{2}} [GeV]", false, "gev");
}
...
void DrawPlot(TString var, TString cut, TString chan, Int_t nbins, Float_t bin0, Float_t binN, TString Xtitle, bool setLegendLeft = false, TString yAxisTitleStyle="", float max = 0.){
  ...
  p->AddSample("DYJetsToLL_M10to50_aMCatNLO"  , "DY"          , itBkg, 852, systlist); // kRed);
