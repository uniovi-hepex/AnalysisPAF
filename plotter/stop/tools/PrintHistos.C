...
TH2F* GetSFfromTH2F(TString path, TString file1, TString file2, TString hname1, TString hname2 = "", TString outname = "SF", TString xtitle = "", TString ytitle = "", Bool_t doErrors = false){
  TString outputDir = "";
  if(outname.Contains("/")) outputDir = outname(0, outname.Last('/'));
