...
//  }
  ...
  Plot_sub(TString variable, TString cuts = "", TString channel = "ElMu", Int_t nbins = 0, Double_t bin0 = 0, Double_t binN = 0, TString tit = "title", TString xtit = "VAR"){
    var    = variable;
    cut    = (cuts);
    chan   = channel;
    nb     = nbins;
  ...
  /* Plot_sub(TString variable, TString cuts = "", TString channel = "ElMu", Int_t nbins = 0, Float_t* bins = 0, TString tit = "title", TString xtit = "VAR"){ */
  /*   var    = variable; */
  /*   cut    = (cuts); */
  /*   chan   = channel; */
  /*   nb     = nbins; */
...
public:
  ...
  virtual Plot_sub* NewPlot(TString newVar = "", TString newCut = "", TString newChan = "", Int_t newnbins = -1, Float_t newbin0 = -999, Float_t newbinN = -999, TString newtitle = "", TString newXtitle = "");
...
class MultiPlot_sub : public Plot_sub{
  public:
  MultiPlot_sub(){};
