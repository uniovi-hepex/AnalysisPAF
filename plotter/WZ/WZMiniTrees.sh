...
root -l -b -q 'RunAnalyserPAF.C("WZTo3LNu"   , "WZ", 32)' 
root -l -b -q 'RunAnalyserPAF.C("WWTo2L2Nu"   ,"WZ", 16)' 
...
root -l -b -q 'RunAnalyserPAF.C("WpWpJJ"   ,"WZ", 30)'
root -l -b -q 'RunAnalyserPAF.C("VHToNonbb_amcatnlo"   ,"WZ", 16)' 
root -l -b -q 'RunAnalyserPAF.C("WWTo2L2Nu_DoubleScat"   ,"WZ", 16)' 
...
# DY, WJets
root -l -b -q 'RunAnalyserPAF.C("WJetsToLNu_MLM & WJetsToLNu_MLM_ext2"           , "WZ",  30)'
root -l -b -q 'RunAnalyserPAF.C("DYJetsToLL_M5to50_MLM"                           , "WZ", 60)'
...
root -l -b -q 'RunAnalyserPAF.C("TTZToLLNuNu_ext1 & TTZToLLNuNu_ext2", "WZ",  32)'
root -l -b -q 'RunAnalyserPAF.C("TTZToLL_M1to10", "WZ",8)' 
root -l -b -q 'RunAnalyserPAF.C("TTHNonbb"                          , "WZ",  8)'
root -l -b -q 'RunAnalyserPAF.C("tZq_ll"                            , "WZ", 32)'
