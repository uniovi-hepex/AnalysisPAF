...
samples=("Tree_TTWToLNu1.root" "Tree_TTWToQQ.root" "Tree_TTZToLLNuNu1.root" "Tree_TTZToQQ.root" "Tree_WGToLNuG.root" "Tree_ZGTo2LG.root" "Tree_TGJets.root" "Tree_TTGJets.root" 
...
# Samples affected by Kike's change of folder: TTZToLLNuNu, ZZ, WJetsToLNu_aMCatNLO, TTHNonbb.
