...
if [ "$1" == "an" ]; then
    ...
    if [ "$2" == "test" ]; then
        ...
        root -l -b -q "RunAnalyserPAF.C(\"TTZToLLNuNu_ext\"						      , \"ttH\", 25)"
        #root -l -b -q "RunAnalyserPAF.C(\"TTZToLLNuNu_ext2\"					       , \"ttH\", 25)"
        ...
        #root -l -b -q "RunAnalyserPAF.C(\"TGJets\"								           , \"ttH\", 25)"
        root -l -b -q "RunAnalyserPAF.C(\"TGJets_ext\"							        , \"ttH\", 45)"
        #root -l -b -q "RunAnalyserPAF.C(\"TTGJets\"								         , \"ttH\", 25)"
        ...
        root -l -b -q "RunAnalyserPAF.C(\"DYJetsToLL_M10to50_aMCatNLO_ext\" , \"ttH\", 25)"
        root -l -b -q "RunAnalyserPAF.C(\"WJetsToLNu_MLM\"						      , \"ttH\", 25)"
        #root -l -b -q "RunAnalyserPAF.C(\"WJetsToLNu_MLM_ext2\"					   , \"ttH\", 25)"
        #root -l -b -q "RunAnalyserPAF.C(\"TW\"									             , \"ttH\", 25)"
        root -l -b -q "RunAnalyserPAF.C(\"TW_ext\"								          , \"ttH\", 25)"
        #root -l -b -q "RunAnalyserPAF.C(\"TbarW\"								           , \"ttH\", 25)"
        root -l -b -q "RunAnalyserPAF.C(\"TbarW_ext\"							          , \"ttH\", 25)"
        ...
        #root -l -b -q "RunAnalyserPAF.C(\"ZZ\"									             , \"ttH\", 25)"
        ...
        #root -l -b -q "RunAnalyserPAF.C(\"WW\"									             , \"ttH\", $2)"
        root -l -b -q "RunAnalyserPAF.C(\"WW_ext\"								          , \"ttH\", $2)"
