...
#(haciendo la trampa de cambiar el datasets) root -l -b -q 'RunAnalyserPAF.C("Tbar_Powheg", "WW", 16)'

#root -l -b -q 'RunAnalyserPAF.C("TTbar_Powheg", "WW", 40)'

root -l -b -q 'RunAnalyserPAF.C("TW_ext", "WW", 16)'
root -l -b -q 'RunAnalyserPAF.C("TbarW_ext", "WW", 16)'
root -l -b -q 'RunAnalyserPAF.C("ZZ_ext", "WW", 16)'
root -l -b -q 'RunAnalyserPAF.C("WW_ext", "WW", 16)'
root -l -b -q 'RunAnalyserPAF.C("WWTo2L2Nu", "WW", 16)'
...
root -l -b -q 'RunAnalyserPAF.C("WJetsToLNu_MLM_ext2", "WW", 16)'
      
root -l -b -q 'RunAnalyserPAF.C("TTWToLNu_ext2", "WW", 40)'
root -l -b -q 'RunAnalyserPAF.C("TTZToQQ", "WW", 16)'
root -l -b -q 'RunAnalyserPAF.C("TTGJets_ext", "WW", 16)'   
